...
\title{Invitation to Post-Doctoral Party}
...
\url{http://www.helsinki.fi/\%7etapirine/phd-defence.html} and on the back side
    of this invite.

    Dresscode: Smart casual, tailcoats or evening dresses are not required.

    RSVP: by the $21^{st}$ of February via email to
    \url{tommi.pirinen+diss@helsinki.fi}
}
