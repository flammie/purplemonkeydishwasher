...
(R E Gorin)~\citep{gorin1971spell} &  & & English affixes & limited to \\
                                  &  & &              & 2 first letters \\
    ...
    (Kevin Atkins) & & & (dropped) & w/ soundslike \\
        ...
        (Kenneth W Church)\citep{church1991probability} & & & & \\
        \hline
        bayspell  & 1995 \\
        (Golding)\citep{golding1995bayesian} \\
        \hline
        WinSpell & 1999 \\
        (Golding and Roth)\citep{golding1999winnow} & \\
        \hline
        \multicolumn{5}{|c|}{\bf Finite-State} \\
        \hline
        (Oflazer)\citep{oflazer1996errortolerant} & 1996 & ED & FSA & Fuzzy search\\
(Agata)\citep{agata2002typographical} & 2002 & ED & FSA & Automata algebra \\
      (Schulz)\citep{schulz2002fast} & 2002 & ED & FSA & Levenshtein automata \\
        (Mohri)\citep{mohri2003edit} & 2003 & ED & WFSA & Automata algebra \\

      (Huldén)\citep{hulden2009fast} & 2009 & FSA Eqv & FSA & A* search, context \\
(Pirinen)\citep{pirinen2010finitestate} & 2010 & WFSA & WFSA & Automata algebra \\
    \end{tabular}
...
was~\citep{pirinen2009weighted}. Then I discuss the techniques behind training
morphologically complex languages, the relevant article for this discussion is
\citep{pirinen2009weighting}. Finally I talk about the common problem with the
combination of less resources and more complex morphology actually requiring
more resources in~\citep{pirinen2010finitestate}, where I propose the use of
...
Finnish Inflection and Compounding} \citep{pirinen2009weighted} by Krister
...
spell-checker. In the article~\citep{pirinen2012improving} we reconstructed the
...
in~\citep{pirinen2012improving}, I also got slight tendency towards the effect
...
string is in given language in linear time~\cite{aho2007compilers}, in
practical measurements this amounts to spell-checking times up to
100,000~strings per second~\cite{silfverberg2009hfst}. The central evaluation
...
as~\cite{bhagat2007spelling}, give some statistics on plausibility of such 
...
languages, such as Arabic, Indian languages~\cite{chaudhuri2002towards},
Hungarian~\cite{tron2005hunmorph} or Spanish~\cite{otero2007contextual}, on top
of the default treatments on English~\cite{mitton1987spelling}.
...
original statistics were at 80~\%~\cite{damerau1964technique}, with various
...
research for non-finite-state systems, e.g. in~\cite{carlson2001scaling}.
