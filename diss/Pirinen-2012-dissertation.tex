...
system.  Specifically in \citepalias{pirinen2010creating} I attempt to recreate
much of Hunspell spell-checking system, including their error correction
methods, in finite-state form. In \citepalias{pirinen2011modularisation} I
...
\citepalias{pirinen2012compiling} by showing conversion of language models
outside the morphological analysers and spell-checkers into a suitable
finite-state automaton. In \citepalias{pirinen2012improving} I tackled the
...
\citepalias{pirinen2010finitestate} I showed that an approach by an extension
