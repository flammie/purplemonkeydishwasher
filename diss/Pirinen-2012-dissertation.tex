...
%%Helsinki, especially those in student organisations like Aspekti and Hyrmy,
%%and the one true deity who shares the initials with finite-state
...
\citepalias{pirinen2011modularisation} I research the topic of maintenance and
...
\citepalias{pirinen2012improving} I tackled the problematic issue of
...
Lindén.  In~\citepalias{pirinen2010finitestate} I already take into account
...
finite-state edit distance, and finally in \citepalias{pirinen2010finitestate}
...
different than the ones used in my work. \todo{explain mohri's definitions and
differences.}.
...
have presented~\citep{linden2009hfst} and \citepalias{pirinen2010building}---I
...
in previous article \citepalias{pirinen2009weighted} the compound
...
in~\citepalias{pirinen2012improving}, I also got slight tendency towards the
...
shown in the article mentioned \citepalias{pirinen2012improving}. The main
