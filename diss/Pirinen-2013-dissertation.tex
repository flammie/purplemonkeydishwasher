...
other methods, this is shown in the Table~\ref{table:cla-2010-repro} 
reproduced from~\citepalias{pirinen2010building}.
...
Table~\ref{table:fsmlnp-2012-repro} from the
...
that the simple edit-distance measure at length one will usually cove the
