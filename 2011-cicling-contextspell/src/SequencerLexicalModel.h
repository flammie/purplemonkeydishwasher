#ifndef HFST_TAGGER_HEADER_SEQUENCER_LEXICAL_MODEL_H
#define HFST_TAGGER_HEADER_SEQUENCER_LEXICAL_MODEL_H
...
class SequencerLexicalModel : public LanguageModel
{
 public:
  ...
  SequencerLexicalModel(std::istream &in,std::string name);

  // This constructor reads a lexical model from the file @a filename.
  SeuqneceLexicalModel(const std::string filename,bool init_tag_probabilities=true);
