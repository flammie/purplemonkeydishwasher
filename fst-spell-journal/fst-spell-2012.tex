...
with our finite-state formulations.\todo{why is this blurb here}.
...
will become a very rare word (e.g. \todo{fetch some example from Kukich}). The
...
in this chapter:\todo{might assign above schemes to variables for easier
reference?}
...
time and the scaling.\todo{trigrams segfault nao}
