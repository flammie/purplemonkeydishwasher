...
makefiles available from our source code repository\footnote{}.\todo{url
    contains version history so it's not anonymous by any measure. also,
new or old sf repo?}
...
containing 88 REP confusion pairs\footnote{}.\todo{url to en-us.aff}
