...
\begin{abstract} 
    ...
    Apart from the issue of non-linguistic evaluation metrics, it is equally
    crucial, to look at the results of the SMT system in sufficient detail to
    explain the scores gained by the system. From
    a meta-analysis
    of the state-of-the-art in English-Finnish SMT that we have conducted
    we identify two parts of the process that would greatly benefit from
