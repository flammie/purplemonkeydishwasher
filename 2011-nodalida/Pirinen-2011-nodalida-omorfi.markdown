...
<span style='font-size:8pt'>(¹ Authors' archival version: Published originally in Nodalida 2011 in Rīga. Official version may be at <http://dspace.utlib.ee/dspace/handle/10062/16955>.)</span>
...
than two decades now [(cites: beesley/2003)](#beesley/2003), it has some recognised flaws and
problems both caused by shortcomings of actual implementations and
background technology [(cites: wintner/2008)](#wintner/2008). Commonly language description is
...
varies from computer scientists to linguists [(cites: maxwell/2008)](#maxwell/2008) to
...
out already in [(cites: koskenniemi/1983)](#koskenniemi/1983), and morphophonological system
...
master’s thesis project [(cites: pirinen/2008)](#pirinen/2008), but afterwards it has been
...
spell checking and correction [(cites: pirinen/2010/lrec)](#pirinen/2010/lrec), lemmatizing for IR
applications (e.g. [(cites: kurola/2010)](#kurola/2010)), named entity recognition, rule-based
machine translation (e.g. Finnish—Northern
Sámi (footnote: <http://apertium.svn.sourceforge.net/viewvc/apertium/incubator/apertium-sme-fin/>))
...
## Modularisation of Finite-State Language Description
<a id="sec:modules">(¶ sec:modules)</a>
...
[(cites: koskenniemi/1983)](#koskenniemi/1983). The further developments of modularisation more or
less have followed from development of finite-state technology along years
from initial implementation of omorfi at publication of [(cites: pirinen/2008)](#pirinen/2008)
to its current open source community developed version.

In figure [(see: fig:modules)](#fig:modules) we give a hierarchical list of abstract
...
dictionary [(cites: linden/2009/nodalida)](#linden/2009/nodalida).  One of the features that has become
...
for any specific type of *tag sets* or morphological analyses so to say,
...
<a id="fig:modules">(¶ fig:modules)</a>)
</div>
...
## Implementation
<a id="sec:implementation">(¶ sec:implementation)</a>
...
system (footnote: <http://home.gna.org/omorfi/>). The system
...
[(cites: beesley/2003)](#beesley/2003). The crucial thing for this modular approach is that it
...
### Lexical Data—Lexicon and Features of Lexical Items
...
cases is yet another forthcoming constraint grammar[(cites: karlsson/1990)](#karlsson/1990) based
...
### Traditional Morphotactics and Phonology—The Lexc and Twolc Model
...
traditional finite-state morphology by [(cites: beesley/2003)](#beesley/2003), even if it was
deemed monolithic and fragile for such collaboration.

### Analysis Formats and Sets
...
[(cites: wintner/2008)](#wintner/2008), ideally derived from standardized set of features, such as
ISOCat as is also suggested by [(cites: maxwell/2008)](#maxwell/2008).


### Orthographical variations

When dealing with data from various sources, such as old literature or
*spoken* standard language found in instant messaging and perhaps
...
applied with on-the-fly composition [(cites: pirinen/2010/cla)](#pirinen/2010/cla) to perform the
...
composition [(cites: linden/2009/nodalida,linden/2009/fsmnlp)](#linden/2009/nodalida,linden/2009/fsmnlp). 

### Filtering the Analyser
...
[(cites: maxwell/2008)](#maxwell/2008), specifically in case of finite-state language
descriptions.
...
* <a id="wintner/2008">**wintner/2008**</a>:
    * error: <strong style="color: red">missing from bibs</strong>
* <a id="maxwell/2008">**maxwell/2008**</a>:
    * error: <strong style="color: red">missing from bibs</strong>
...
* <a id="pirinen/2010/lrec">**pirinen/2010/lrec**</a>:
    * error: <strong style="color: red">missing from bibs</strong>
* <a id="kurola/2010">**kurola/2010**</a>:
    * error: <strong style="color: red">missing from bibs</strong>
* <a id="linden/2009/nodalida">**linden/2009/nodalida**</a>:
    * error: <strong style="color: red">missing from bibs</strong>
* <a id="karlsson/1990">**karlsson/1990**</a>:
    * error: <strong style="color: red">missing from bibs</strong>
* <a id="pirinen/2010/cla">**pirinen/2010/cla**</a>:
    * error: <strong style="color: red">missing from bibs</strong>
* <a id="linden/2009/fsmnlp">**linden/2009/fsmnlp**</a>:
    * error: <strong style="color: red">missing from bibs</strong>
