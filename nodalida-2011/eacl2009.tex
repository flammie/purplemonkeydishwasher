...
\title{Instructions for EACL-09 Proceedings}

\author{Kemal Of\/lazer\\
  Sabanc{\i} University\\
  Istanbul, Turkey\\
  {\tt oflazer@gmail.com}  \And
  David Schlangen\\
  Universit\"{a}t Potsdam\\
  Potsdam, Germany\\
  {\tt  das@ling.uni-potsdam.de}}
...
\begin{abstract}
  ...
  manuscript for the proceedings of EACL-09. The document itself
...
This document has been adapted from the instructions for EACL-06 and ACL-08
proceedings, by Kemal Of\/lazer and David Schlangen. 
...
to EACL-09 or  accepted
for publication in the EACL-09 proceedings. All authors are required
...
systems is limited should contact the publication chairs Kemal Oflazer
(\texttt{oflazer@gmail.com}) and David Schlangen
(\texttt{das@ling.uni-potsdam.de}) as soon as possible.
...
EACL provides this description in \LaTeX2e (eacl2009.tex) and PDF
format (eacl2009.pdf), along with the \LaTeX2e style file used to
format it (eacl2009.sty) and an ACL bibliography style
(acl.bst). These files are all available at
\url{http://www.eacl2009.gr/conference/authors}. A Microsoft Word
template file (eacl2009.dot) is also available at the same URL. We
strongly recommend the use of these style files, which have been
appropriately tailored for the EACL-09 proceedings. If you have an
...
in all capitals (e.g., use ``Schlangen'' not ``SCHLANGEN'').  The
...
Eight pages (8) is the maximum length of the main text of papers for the EACL-09
