...
\title{Template for IWCLUL 2017 Workshop Proceedings\blfootnote{
...
\begin{abstract}
    Abstraktin voi kirjoittaa myös suomeksi tai muulla uralilaisella kielellä.
\end{abstract}
}
...
\begin{abstract}
Abstract in Russian is also possible
\end{abstract}
}
